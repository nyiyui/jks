...
/// Screen where user records current activity.
class RecordScreen extends StatelessWidget {
  /// Constructs a [RecordScreen]
...
class RecordFormState extends State<RecordForm> {
  ...
  Widget build(BuildContext context) {
    ...
    //          labelText: 'Date',
    //        ),
    //        initialValue: dateFormat.format(new DateTime.now()),
    //      ),
    //      TextFormField(
    //        decoration: const InputDecoration(
    //          labelText: 'Start',
    //        ),
    //        initialValue: timeFormat.format(new DateTime.now()),
    //      ),
    //      TextFormField(
    //        decoration: const InputDecoration(
    //          labelText: 'End',
    ...
    //            },
    //          };
    //          http.post(new Uri.http('localhost:8080/activity/new'), body: json.encode(data));
